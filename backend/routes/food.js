...
const FOOD_SEARCH_VARIANT_HINTS = {
  bacon: ['smoked bacon', 'pork bacon', 'bacon strips'],
  ham: ['smoked ham', 'deli ham'],
  sausage: ['breakfast sausage', 'pork sausage'],
  ...
  noodles: ['instant noodles', 'ramen noodles'],
  ramen: ['ramen noodles', 'instant ramen', 'noodle soup'],
  cake: ['chocolate cake', 'cheesecake', 'pound cake', 'birthday cake'],
  dango: ['sweet dango'],
  kikiam: ['kikiam', 'oden'],
  fishball: ['fish balls', 'oden'],
  juice: ['beverage box', 'juice box', 'boxed juice'],
};
...
const buildHeuristicSearchTerms = (query) => {
  ...
  if (cleaned.split(' ').length === 1) {
    const variantHints = FOOD_SEARCH_VARIANT_HINTS[cleaned] || [];
    terms.push(...variantHints);
  }
...
const LOCAL_FOOD_FALLBACKS = [
  ...
  { name: 'Bacon', aliases: ['bacon', 'smoked bacon', 'pork bacon', 'side bacon', 'streaky bacon'], calories: 541, protein: 37, carbs: 1.4, fat: 42, fiber: 0, sugar: 1.1, category: 'protein' },
  { name: 'Ham', aliases: ['ham', 'smoked ham', 'deli ham'], calories: 145, protein: 21, carbs: 1.5, fat: 6, fiber: 0, sugar: 1.2, category: 'protein' },
  { name: 'Breakfast Sausage', aliases: ['sausage', 'sausages', 'pork sausage', 'breakfast sausage'], calories: 301, protein: 14, carbs: 3, fat: 26, fiber: 0, sugar: 0.8, category: 'protein' },
  { name: 'Pork Chop', aliases: ['pork chop', 'pork chops'], calories: 231, protein: 25.7, carbs: 0, fat: 13.9, fiber: 0, sugar: 0, category: 'protein' },
  ...
  { name: 'Instant Ramen', aliases: ['ramen', 'ramen noodles', 'noodle soup', 'instant noodles'], calories: 436, protein: 9, carbs: 59, fat: 18, fiber: 2.5, sugar: 2.4, category: 'grains' },
  { name: 'Soup', aliases: ['soup', 'broth', 'stew', 'chowder'], calories: 90, protein: 4, carbs: 10, fat: 3, fiber: 1, sugar: 2, category: 'snacks' },
  { name: 'Cake', aliases: ['cake', 'cakes', 'chocolate cake', 'cheesecake', 'pound cake'], calories: 257, protein: 3.6, carbs: 37.3, fat: 10.1, fiber: 0.8, sugar: 23.7, category: 'snacks' },
  { name: 'Dango', aliases: ['dango', 'sweet dango'], calories: 189, protein: 3.1, carbs: 45.2, fat: 1, fiber: 0.5, sugar: 18, category: 'snacks' },
  { name: 'Fish Balls', aliases: ['fishball', 'fish balls', 'kikiam', 'fish cake', 'surimi', 'oden'], calories: 180, protein: 12, carbs: 16, fat: 7, fiber: 0, sugar: 2, category: 'protein' },
  { name: 'Beverage Box Juice', aliases: ['beverage box', 'juice box', 'boxed juice'], calories: 54, protein: 0.7, carbs: 13.2, fat: 0.1, fiber: 0.2, sugar: 11.8, category: 'beverages' },
