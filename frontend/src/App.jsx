...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/reset-password/new" element={user ? <Navigate to="/dashboard" /> : <SetNewPassword />} />
      <Route path="/reset-password/:token" element={user ? <Navigate to="/dashboard" /> : <ResetPassword />} />
      <Route path="/reset-password-success" element={user ? <Navigate to="/dashboard" /> : <ResetPasswordSuccess />} />
